...
public class AdapterUpcomingMovie extends RecyclerView.Adapter<UpcomingViewHolder> {
    ...
    public AdapterUpcomingMovie(Context context, List<MovieModel> movieList) {
    ...
    public UpcomingViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        return new UpcomingViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movie_upcoming, parent, false));
    }
